...
//    implementation("com.knuddels:jtokkit:1.0.0")
    ...
    implementation("dev.langchain4j:langchain4j-qianfan:0.33.0") // The Baidu Qianfan Large Model Platform, including the ERNIE series, can be accessed at https://docs.langchain4j.dev/integrations/language-models/qianfan/.
